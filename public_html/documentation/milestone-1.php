...
<html lang="en">
	...
	<body>
		...
		<!-- start purpose, audience, and goals section -->
		<section>
			<h2>Purpose, Audience, and Goals</h2>
			<ol>
				<li><strong>Purpose:</strong> This website will be where I display my web development portfolio and contact information.</li>
				<li><strong>Audience:</strong> Potential employers and other web developers who are looking for an intern or junior web developer as well as clients looking for a freelance web developer will be the audience for this website.</li>
				<li><strong>Goals:</strong> I want to this website to highlight my work so I can get hired for part-time or full-time work as a junior web developer or intern as well as freelance jobs.</li>
			</ol>
		...
		<section>
			<h2>Persona</h2>
				<ul>
					<li><strong>Name:</strong> Christina Bossypants</li>
